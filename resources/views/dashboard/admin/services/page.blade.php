...
<div class="row">
    <div class="">
        <div class="card">
            <div class="card-body">
                <h4 class="fw-bold py-3 mb-4 text-center">จัดการบริการ</h4>
                ...
                <div class="modal fade" id="createServiceModal" tabindex="-1" aria-labelledby="createServiceModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('AdminServicesCreate') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm small-card">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ route('AdminServicesDetail', $service->id) }}" class="btn btn-sm btn-primary mx-1" title="ดูเพิ่มเติม"><i class='bx bx-detail'></i></a>
                                ...
                                <form action="{{ route('AdminServicesDelete', $service->id) }}" method="POST" onsubmit="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบ?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
