...
<div class="row">
    <div class="">
        <div class="card">
            <div class="card-body">
                <h4 class="fw-bold py-3 mb-4 text-center">จัดการโปรโมชั่น</h4>
                ...
                <div class="modal fade" id="createPromotionModal" tabindex="-1" aria-labelledby="createPromotionModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('AdminPromotionsCreate') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-footer text-center">
                                <a href="{{ route('AdminPromotionsDetail', $promotion->id) }}" class="btn btn-sm btn-primary mx-1" title="ดูเพิ่มเติม"><i class="bx bx-detail"></i></a>
                                ...
                                <form action="{{ route('AdminPromotionsDelete', $promotion->id) }}" method="POST" onsubmit="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบ?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="modal fade" id="editPromotionModal{{ $promotion->id }}" tabindex="-1" aria-labelledby="editPromotionModalLabel{{ $promotion->id }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('AdminPromotionsUpdate', $promotion->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="modal-content">
                                <div class="modal-header">
